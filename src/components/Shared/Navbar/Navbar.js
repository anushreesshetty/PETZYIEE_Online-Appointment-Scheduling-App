        ...
        <nav className={`navbar navbar-expand-lg navbar-light ${isSticky ? "stickynav" : "normalnav"}`} expand="lg">
            ...
            <div className="container-fluid">
                <div className="navbar-heading">
                    ...
                    {/* <img src="../../images/logo1.ico" alt="logo" width={100} height={100} /> */}
                    </h3>
                </div>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav  mb-2 mb-lg-0 ms-auto">
                        <li className="nav-item">
                            <a className="nav-link active me-3 textDark" aria-current="page" href="/">HOME</a>
                        </li>
                        ...
                        <li className="nav-item">
                            <a className="nav-link me-3 textDark" href="#service" >SERVICES</a>
                        </li>
